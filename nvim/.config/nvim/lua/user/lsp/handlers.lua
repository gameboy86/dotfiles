...
-- TIP https://github.com/neovim/neovim/pull/16057
-- change from show_line_diagnostics to open_float
-- END TIP
...
-- TIP from: https://github-wiki-see.page/m/neovim/nvim-lspconfig/wiki/UI-customization
