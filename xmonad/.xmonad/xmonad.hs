...
myManageHook = composeAll . concat $
    ...
    myCFloats = ["Arcolinux-calamares-tool.py", "Archlinux-tweak-tool.py", "Arcolinux-welcome-app.py", "Galculator", "feh", "mpv", "Xfce4-terminal"]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((controlMask .|. modMask , xK_k ), spawn $ "flameshot gui")
